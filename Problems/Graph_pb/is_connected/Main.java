...
class Graph {
 ...
 public void addUNDirectedEdge(int src, int dst, int cost){
  ...
  public boolean isConnected(){
    boolean visited[] = DFS(vertices[0].src);
    for(boolean i:visited) 
      if (i == false) return false;
...
public class Main{
 public static void main(String args[]) {
  ...
  System.out.println("Create a Directed NOT CONNECTED graph of 14 elements : it would never be connected, there are vertex at null " + g.isConnected());
  g = new Graph(15);
  System.out.println("Add 2 not connected nodes");
  g.addDirectedEdge(0, 1, 1);
  g.addDirectedEdge(0, 4, 1);
  g.addDirectedEdge(0, 5, 1);
  g.addDirectedEdge(2, 1, 1);
...
Vertex : 4
Vertex : 5
Create a Directed NOT CONNECTED graph of 14 elements : it would never be connected, there are vertex at null true
Add 2 not connected nodes
Vertex : 0
Vertex : 1
Vertex : 3
Vertex : 2

...
class MaxPriorityQueue{
  ...
  public void filterKSmallestFromStream(int newNum, int k){
    // edge cases
    if (k<=0) {
...
public class Main{
  ...
  public static void main(String args[]){
    ...
    int k = 5;
    System.out.println("First "+k+ " smallest number in array");
    for(int i=0; i< arr.length; i++){
      pq.filterKSmallestFromStream(arr[i],k);
    }
    pq.printArr();
    ...
    // check
    System.out.println("\nOrdered array :  ");
    MaxPriorityQueue check = new MaxPriorityQueue(arr);

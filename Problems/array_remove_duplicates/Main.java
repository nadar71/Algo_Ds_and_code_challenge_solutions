...
class HashTable{
  ...
  public void print(){
    for(int i=0; i<tableSize; i++){
      ...
      while(head != null){
        System.out.println("Print for index value : "+i+" Values :: "+head.data);
        head = head.next;
      }
    }
  }
  ...
  // convert an hashtable in int array without duplicates
  public int[] toArray(){
...
public class Main{
  ...
  public static void main(String args[]){
    int[] a = {1,2,3,3,2,2,1,3,4,5,66,7,6,5,6,7};
    int[] res;

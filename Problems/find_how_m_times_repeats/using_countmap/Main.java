...
class CountMap{
  ...
  // print all the item which has count>1
  public void printRepeating(){
    for(int i=0; i<sizeCountMap; i++)
      if (getData(i) > 1) System.out.println("This number : "+i+ " repeats times : "+getData(i)); 
  }
